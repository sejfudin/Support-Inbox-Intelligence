    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          className={cn(
            'flex items-center gap-2 px-3 py-2.5 rounded-[var(--r-control)] text-xs font-bold uppercase transition-colors outline-none ring-offset-background focus:ring-2 focus:ring-ring focus:ring-offset-2',
