/**
 * FROZEN — the pre-overhaul page heading (hero card + kicker), used only by the
 * dashboards' frozen list. See LegacyTicketsHeader.jsx for why this exists.
 */
import { cn } from '@/lib/utils';

export default function LegacyPageHeading({
  kicker,
  title,
  subtitle,
  actions,
