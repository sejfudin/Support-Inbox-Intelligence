...
const { getSettings, updateSettings, resetSettings } = require('../controllers/attendanceSettings');
...
//
// Its own file rather than a `/settings` branch inside routes/attendanceRequest.js
