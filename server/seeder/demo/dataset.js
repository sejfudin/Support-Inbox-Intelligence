...
const interns = [
  ...
  },
  {
    ...
    readiness: [{ technology: 'docker', level: 'learning' }],
  },
  {
    key: 'sara',
  ...
  },
  {
    ...
    attendance: { persona: 'average', absentEvery: 5, today: 'none' },
    readiness: [{ technology: 'pytorch', level: 'ready' }],
  },
  {
    key: 'sabahudin',
    ...
    attendance: { persona: 'star', absentEvery: 20, today: 'none' },
    readiness: [
      { technology: 'pandas', level: 'ready' },
      { position: 'data-engineer', level: 'ready' },
    ],
  },
  {
    key: 'lamija',
  ...
  },
  {
    ...
    technologies: ['sql', 'fastapi'],
    attendance: null,
    readiness: [{ technology: 'sql', level: 'ready' }],
  },
  {
    key: 'haris',
    ...
    technologies: ['docker', 'go'],
    attendance: null,
    readiness: [{ technology: 'docker', level: 'ready' }],
  },
  {
    key: 'dino',
  ...
  },
  {
    ...
    technologies: ['react'],
    attendance: null,
    readiness: [{ position: 'ui-ux-designer', level: 'ready' }],
  },
  {
    key: 'hamzaT',
...
const recommendations = [
  ...
  },
  {
    key: 'goranBench',
    internKey: 'goran',
    positionSlug: 'cybersecurity-engineer',
    projectKey: null,
    technologies: ['go'],
    status: 'resulted',
